...
│   ├── settings.py             # Paramètres (DB, apps, static files)
...
├── add_ia_links.py             # Script d'ajout de liens IA en masse
├── export_project.py           # Export du projet en archive
